...
use StringKe\FilamentTree\Commands\FilamentTreeCommand;
use StringKe\FilamentTree\Testing\TestsFilamentTree;
...
class FilamentTreeServiceProvider extends PackageServiceProvider
{
        ...
        $package->name(static::$name)
            ...
            ->hasInstallCommand(function (InstallCommand $command): void {
                $command
                    ...
                    ->publishMigrations()
                    ->askToRunMigrations()
                    ->askToStarRepoOnGitHub('stringke/filament-tree');
            });
    ...
    public function packageBooted(): void
    {
        ...
        if (app()->runningInConsole()) {
            foreach (app(Filesystem::class)->files(__DIR__ . '/../stubs/') as $file) {
                $this->publishes([
                    $file->getRealPath() => base_path("stubs/filament-tree/{$file->getFilename()}"),
                ], 'filament-tree-stubs');
            }
        }
    ...
    {
        return [
            // AlpineComponent::make('filament-tree', __DIR__ . '/../resources/dist/components/filament-tree.js'),
